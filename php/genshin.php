            ...
            <div class="main">
                <div class="menu">
                    ...
                    <div class="text">
                        ...
                        <p>Cara Top Up Crystal di Genshin Impact :</p>
                        <ol>
                            <li>Masukan ID</li>
                            <li>Pilih Nominal GC</li>
                            <li>Pilih Metode Pembayaran</li>
                            <li>Klik Order Now & Lakukan Pembayaran</li>
                            <li>GC Akan Masuk Otomatis ke Akun Anda</li>
                        </ol>
                    </div>
                </div>
                <div class="top-up">
                    ...
                    <div class="item">
                        ...
                        <div class="container">
                            <div class="grid-container">
                                <?php 
                                $data = "SELECT * FROM `kategori` WHERE `kategori` = 'genshin'";
