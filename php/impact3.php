            ...
            <div class="main">
                <div class="menu">
                    ...
                    <div class="text">
                        ...
                        <p>Cara Top Up Crystal Atau B-Chip Honkai Impact 3  :</p>
                        <ol>
                            <li>Masukan ID</li>
                            <li>Pilih Nominal B-Chip</li>
                            <li>Pilih Metode Pembayaran</li>
                            <li>Klik Order Now & Lakukan Pembayaran</li>
                            <li>B-Chip Akan Masuk Otomatis ke Akun Anda</li>
                        </ol>
                    </div>
                </div>
                <div class="top-up">
                    ...
                    <div class="item">
                        ...
                        <div class="container">
                            <div class="grid-container">
                                <?php 
                                $data = "SELECT * FROM `kategori` WHERE `kategori` = 'honkai'";
